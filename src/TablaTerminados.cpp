...
void TablaTerminados::agregarProceso(const Proceso& proceso, const QString& operacion, const QString& resultado, int numeroLote) {
    ...
    this->setItem(fila, 3, new QTableWidgetItem(QString::number(numeroLote)));
}